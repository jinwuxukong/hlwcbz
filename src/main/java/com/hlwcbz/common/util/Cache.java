...
public class Cache {
     ...
     * 预缓存信息
     */
    private static final Map<String, Object> CACHE_MAP = new ConcurrentHashMap<String, Object>(INITIAL_CAPACITY,LOAD_FACTOR,1);
     ...
     * 每个缓存生效时间60秒
     */
    public static final long CACHE_HOLD_TIME_60S = 60 * 1000L;
