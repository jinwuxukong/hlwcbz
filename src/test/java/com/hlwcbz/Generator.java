...
public class Generator {
    ...
    private final static String DB_URL = "jdbc:mysql://122.51.118.51:3306/hlwcbz_dev?serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf8&useSSL=false";
    private final static String DB_USER_NAME = "root";
    private final static String DB_PASSWORD = "1234";

    private final static String PACKAGE_NAME = "com.hutu.modules.admin.login";
    // 需要生成的表名
